...
if (isset($_POST["Username"]))
{
    ...
    $mysql = "DELETE FROM AssistantStore WHERE Username='".$Username."'";
...
<head>
    <meta charset="UTF-8">
    <title>Διαγραφή Υπαλλήλου Τοπικού Καταστήματος</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h1>Διαγραφή Υπαλλήλου Τοπικού Καταστήματος</h1>
                    </div>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            ...
                            <p>
                                ...
                                <a href="../admin_assistant_store.php" class="btn btn-default">Όχι</a>
                            </p>
                        </div>
                    </form>
                </div>
